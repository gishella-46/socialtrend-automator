...
/**
 * Create permission tables migration (for Spatie Laravel Permission)
 */
return new class extends Migration
{
    ...
    {
        $teams = false; // Set to true if you want team-based permissions
        ...
        Schema::create('model_has_permissions', function (Blueprint $table) use ($teams) {
            ...
            $table->unsignedBigInteger($teams ? 'model_id' : 'model_id');
